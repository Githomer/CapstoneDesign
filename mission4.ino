...
String url = "/update?api_key=W5TIC0DRM1JHKFCO";   // Your Own Key here
...
const char* ssid = "KT_WLAN_8362";   // Your own ssid here
const char* password = "000000162a";  // Your own password here

String working(int r) { 
 // do some magic here!
